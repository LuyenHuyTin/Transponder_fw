...
namespace EsyPro {
    ...
    enum CommunicationCmd_t {
        ...
        CMD_BASIC_TRANS_COMM_BASE = 0x70,
        CMD_BASIC_TRANS_SETUP_REQ = 0x00,
        CMD_BASIC_TRANS_SETUP_RES = 0x70,
        CMD_BASIC_TRANS_READ_DATA_REQ = 0x01,
        CMD_BASIC_TRANS_READ_DATA_RES = 0x71,
        CMD_BASIC_TRANS_WRITE_DATA_REQ = 0x02,
        CMD_BASIC_TRANS_WRITE_DATA_RES = 0x72,
        //CMD_BASIC_MEM_END_READ_DATA_RES = 0x53,
